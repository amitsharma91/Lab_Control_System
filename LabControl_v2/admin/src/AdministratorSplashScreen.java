...
public class AdministratorSplashScreen extends JWindow {

	private static final long serialVersionUID = 1L;
	static boolean isRegistered;
	private static JProgressBar progressBar = new JProgressBar();
	private static AdministratorSplashScreen execute;
	private static int count;
	private static Timer timer1;

	public AdministratorSplashScreen() {

		Container container = getContentPane();
		container.setLayout(null);

		ImageIcon icon = new ImageIcon(AdministratorSplashScreen.class.getResource("/img/back.jpg"));
	...
	public static void main(String[] args) {
		execute = new AdministratorSplashScreen();
	}
};