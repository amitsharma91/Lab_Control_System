...
public class TeacherSplashScreen extends JWindow {

	private static final long serialVersionUID = 1L;
	static boolean isRegistered;
	private static JProgressBar progressBar = new JProgressBar();
	private static TeacherSplashScreen execute;
	...
	public TeacherSplashScreen() {
		...
		ImageIcon icon = new ImageIcon(TeacherSplashScreen.class.getResource("img/back.jpg"));
	...
	public static void main(String[] args) {
		execute = new TeacherSplashScreen();
	}
};