...
public class StudentSplashScreen extends JWindow {

	private static final long serialVersionUID = 1L;
	static boolean isRegistered;
	private static JProgressBar progressBar = new JProgressBar();
	private static StudentSplashScreen execute;
	private static int count;
	private static Timer timer1;

	public StudentSplashScreen() {

		Container container = getContentPane();
		container.setLayout(null);

		ImageIcon icon = new ImageIcon(StudentSplashScreen.class.getResource("img/back.jpg"));
	...
	public static void main(String[] args) {
		execute = new StudentSplashScreen();
	}
};